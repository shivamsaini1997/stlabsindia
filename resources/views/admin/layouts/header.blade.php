...
<div class="page-wrapper compact-wrapper" id="pageWrapper">
    <header class="page-header row">
        <div class="logo-wrapper d-flex align-items-center col-auto"><a href="{{ route('admin.dashboard') }}">
                <img class="light-logo img-fluid" src="{{ asset('backend/stlabindia.png') }}"
                    style="width:60%;" alt="stlabindia" />
                <img class="dark-logo img-fluid" src="{{ asset('backend/stlabindia.png') }}"
                    style="width: 60%;" alt="stlabindia" /></a>
        ...
        <div class="page-main-header col">
            ...
            <div class="nav-right">
                <ul class="header-right" style="margin-bottom: 0">
                        ...
                        <div class="custom-menu overflow-hidden">
                            <ul class="profile-body">
                                ...
                                <li class="d-flex">
                                    ...
                                    <a class="ms-2" href="{{ route('admin.logout') }}">Log Out</a>
                                </li>
                            </ul>
                        </div>
                    </li>
